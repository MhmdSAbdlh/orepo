...
function loadPackageInfo() {
	...
	if (navigator.userAgent.search(/Cydia/) == -1) {
		$("#showAddRepo_").show();
		$("#open_cydia").attr("href","cydia://url/https://cydia.saurik.com/api/share#?source=https://mhmdsabdlh.github.io/&package="+urlSelfParts[1]);
	}
	$.ajax({
		url: form_url,
		type: "GET",
		...
		success: function (returnhtml) {
			...
			if(decodeResp.firmware) {
				$("#firmware_").show();
				$("#firmware").html(decodeResp.firmware);
